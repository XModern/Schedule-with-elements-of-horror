		...
		<div class = "calendar_table" align = "center">
			<table>
				...
				<tr style="padding:0;marign:0; background-color:#909090;">
					...
					<td style="width:14.3%; border:1px solid white; background-color:#aaa;color:blue;margin:0;padding:0;font:9pt sans-serif">
						<font>Сб</font>
					</td>
					<td style="width:14.3%; border:1px solid white; background-color:#aaa;color:blue;margin:0;padding:0;font:9pt sans-serif">
						<font>Вс</font>
				...
				?>
					<td style = "height:30px;">
						<label style="color:<?= $color?>"><?echo $day;?></label>
					</td>	
				<?php
						$day++;
						$weekday++;
